...
% Create a for-loop that is going to loop over each subject in this...
% subset of subjects, i.e. those whose IDs are 12 or higher.
% On each iteration of the for-loop over this subset of IDs, generate...
...
% A tab-delimited table specifying the number of trials for each subject...
...
% When generating your subject ID, you have to append the subject ID...
...
% 001, or 0001, etc.
% A tab-delimited table specifying the mean score for each subject in ...
